...
const outputsInfo = {
  ...
  PostAvgAggregate: ["viewCount"],
  PostSumAggregate: ["viewCount"],
...
const inputsInfo = {
  ...
  PostCreateInput: ["id", "createdAt", "updatedAt", "title", "content", "published", "viewCount", "author"],
  ...
  PostAvgOrderByAggregateInput: ["viewCount"],
  ...
  PostSumOrderByAggregateInput: ["viewCount"],
  ...
  PostCreateWithoutAuthorInput: ["id", "createdAt", "updatedAt", "title", "content", "published", "viewCount"],
